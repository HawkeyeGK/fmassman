            ...
            string playerId)
        {
            try
            {
                ...
                var bgPayload = new
                {
                    ...
                    geometry = new { width = 510, height = 270 },
                ...
                // x: +200, y: -105. Width 90. Align Right.
                ...
                // x: -50, y: -15. Width 390. Align Left.
                ...
                var bodyRolesPayload = new
                {
                    ...
                    geometry = new { width = 390 },
                    position = new { x = posX - 50, y = posY - 15 }
                };
                ...
                // x: +200, y: -15. Width 90. Align Right.
                ...
                var bodyBioPayload = new
                {
                    ...
                    geometry = new { width = 90 },
                    position = new { x = posX + 200, y = posY - 15 }
                };
